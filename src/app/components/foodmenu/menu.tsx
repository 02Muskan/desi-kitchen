...
const Menu = () => {
    ...
    const items = [
        { id: 1, name: "Noodles", price: "$7.2", imgSrc: "/images/Thalifour.png" },
        { id: 2, name: "Pasta", price: "$6.2", imgSrc: "/images/Thalitwo.png" },
        { id: 3, name: "Biryani", price: "$9.5", imgSrc: "/images/Thalithree.png" },
        { id: 4, name: "Spring Rolls", price: "$5.0", imgSrc: "/images/Thalifour.png" },
        { id: 5, name: "Soup", price: "$4.5", imgSrc: "/images/Thalifour.png" },
    ];

...
const Menu = () => {
  ...
  const items = [
    {
      ...
      name: "Regular Thali",
      price: "₹250",
      imgSrc: "/images/Thalifour.png",
      category: "Thalis",
      description:
        "A balanced meal with **Dal Tadka, Mix Veg, Jeera Rice, Roti, Salad, and Gulab Jamun.** Perfect for daily lunch! 🍛",
    },
    {
      id: 2,
      name: "Desi Special Thali",
      price: "₹350",
      imgSrc: "/images/Thalitwo.png",
      category: "Thalis",
      description:
        "A desi feast with **Paneer Butter Masala, Dal Makhani, Lachha Paratha, Jeera Rice, Chaas, and Gulab Jamun.** Pure delight! 🍽️",
    },
    {
      id: 3,
      name: "Maharaja Thali",
      price: "₹499",
      imgSrc: "/images/Thalithree.png",
      category: "Thalis",
      description:
        "A royal platter with **Paneer Butter Masala, Dal Tadka, Mix Veg, Jeera Rice, Tandoori Roti, Papad, Salad, Gulab Jamun, and Chaas.** A feast for true food lovers! 👑🍛",
    },
    {
      id: 4,
      name: "Muri Mix",
      ...
      category: "Snacks",
      description:
        "A crispy and flavorful street food mix with **puffed rice, peanuts, sev, onions, and tangy chutney.** A crunchy delight! 🌶️",
    },
    {
      id: 5,
      name: "Chura Mix",
      ...
      category: "Snacks",
      description:
        "A delicious snack made with **flattened rice, dry fruits, sev, and mild spices.** Perfect for tea time! ☕",
    },
  ];
  ...
  return (
    <div className="relative bg-yellow-50 py-8 px-4 flex flex-col items-center">
      <h2 className="text-3xl font-bold text-center text-gray-800 m-4">
        Specials
      </h2>

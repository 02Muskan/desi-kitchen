...
const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  return (
    <div
      className={`absolute top-0 right-0 h-full w-full max-w-md bg-white shadow-xl z-50 transform border rounded-[70px] transition-transform duration-300 ease-in-out ${
    ...
    >
        ...
        {cartItems.map((item) => (
          <div key={item.id} className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button className="border rounded px-2 py-0.5 text-sm">
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t p-4 bg-white">
        ...
        <div className="flex gap-2">
          ...
          <button
            className="flex-1 bg-orange-500 text-white text-sm py-2 rounded hover:bg-orange-600 transition"

    ...
    return (
        <div className="relative bg-gradient-to-r from-[#F9655B] to-[#EE821A] rounded-[70px] flex items-center justify-between w-full overflow-hidden text-white">
            <div className="pl-4 pb-5 pt-4 ml-6">
                ...
                <div className="flex-1 pr-6 mt-10"> {/* Add mt-10 here */}
                    <h2 className="text-3xl font-bold mb-2">20% off on your first food</h2>
                    <p className="text-white mb-4">Customers get 20% off their first order</p>
